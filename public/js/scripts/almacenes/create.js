...
let registrarAlmacenButton = document.getElementById(
    "registrarAlmacen"
);
let nombre_almacen = document.getElementById("nombre_almacen");
...
registrarAlmacenButton.addEventListener("click", function (event) {
    event.preventDefault();

    fetch(ruta_guardar_almacenes, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
            nombre_almacen: nombre_almacen.value,
            capacidad_almacen: capacidad_almacen.value,
            encargado_id: encargado_id.value,
            ...
            if (data.status == 200) {
                M.toast({
                    ...
                    completeCallback: function () {
                        window.location.href = ruta_index_almacenes;
                    },
                });
            } else {
                M.toast({
