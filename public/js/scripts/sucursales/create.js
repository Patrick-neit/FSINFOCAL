...
let registrarSucursalButton = document.getElementById(
    "registrarSucursalButton"
);
...
let sucursal_id = document.getElementById("id_sucursal");

registrarSucursalButton.addEventListener("click", function (event) {
    event.preventDefault();
    fetch(ruta_guardar_sucursal, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
            ...
            nombre_sucursal: nombre_sucursal.value,
            direccion: direccion.value,
            codigo_sucursal: codigo_sucursal.value,
            ...
            if (data.status == 200) {
                M.toast({
                    ...
                    completeCallback: function () {
                        window.location.href = ruta_index_sucursal;
                    },
                });
            } else {
                M.toast({
