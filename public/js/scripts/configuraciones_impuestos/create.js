...
let registrarConfiguracionImpuestoButton = document.getElementById(
    "registrarConfiguracionImpuestoButton"
);
...
let estado_empresa = document.getElementById("estado");
let id_conf = document.getElementById("id_conf");

registrarConfiguracionImpuestoButton.addEventListener(
    "click",
    function (event) {
        event.preventDefault();
        fetch(ruta_guardar_configuraciones_impuestos, {
            method: "POST",
            headers: {
            ...
            body: JSON.stringify({
                id_conf: id_conf.value == "" ? 0 : id_conf.value,
                estado: estado_empresa.value,
                    ...
                    M.toast({
                        ...
                        completeCallback: function () {
                            window.location.href =
                                ruta_index_configuraciones_impuestos;
                        },
                    });
                } else {
                    M.toast({
