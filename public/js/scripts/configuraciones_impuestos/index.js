...
if ($("#configimp-list-datatable").length > 0) {
    usersTable = $("#configimp-list-datatable").DataTable({
        lengthChange: false,
        responsive: true,
        autoWidth: false,
        searching: false,
...
$(document).on("click", "#configimp-list-datatable tr", function () {
    $(this)
        .find("td")
        .each(function () {
...
/* Eliminar Docente */
function eliminar(e) {
    fetch(ruta_eliminar_configuraciones_impuestos, {
        method: "DELETE",
        headers: {
