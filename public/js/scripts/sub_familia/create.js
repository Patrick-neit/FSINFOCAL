...
let registrarSubFamiliaButton = document.getElementById(
    "registrarSubFamiliaButton"
);
...
let sub_familia_id = document.getElementById("id_sub_familia");
...
registrarSubFamiliaButton.addEventListener("click", function (event) {
    ...
    fetch(ruta_guardar_sub_familia, {
        ...
        body: JSON.stringify({
            nombre_sub_familia: nombre_sub_familia.value,
            familia_id: familia_id.value,
            estado: estado.value,
            sub_familia_id: sub_familia_id.value,
        }),
    })
