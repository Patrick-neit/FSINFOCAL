            ...
            <div class="row">
              ...
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="nombre_empresa" name="nombre_empresa" type="text" class="validate" value="{{old('nombre_empresa')}}"
                      data-error=".errorTxt1" required>
                    <label for="nombre_empresa">Nombre Empresa</label>
                    <small class="errorTxt1"></small>
                  </div>
                  <div class="col s12 input-field">
                    <input id="nro_nit_empresa" name="nro_nit_empresa" type="text" class="validate" value="{{old('nro_nit_empresa')}}"
              ...
              <div class="col s12 m6">
                <div class="row">
                  ...
                  <div class="col s12 input-field">
                    <input id="telefono" name="telefono" type="number" class="validate" value="{{old('telefono')}}"
                      data-error=".errorTxt2" required>
                    <label for="telefono">Telefono</label>
                    <small class="errorTxt2"></small>
                  </div>
                  <div class="col s12 input-field">
                    <input id="representante_legal" name="representante_legal" type="text" class="validate" value="{{old('representante_legal')}}"
                      data-error=".errorTxt3" required>
              ...
              <div class="col s12 display-flex justify-content-end mt-3">
                <button  id="registrarEmpresaButton" class="btn indigo">
                  Save changes</button>
