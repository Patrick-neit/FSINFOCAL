                      ...
                      <div class="right-align">
                        ...
                        <div class="invoice-create-btn">
                          <a href="{{ route('empresas.create') }}"
                            ...
                            <span class="hide-on-small-only">Create Enterprise</span>
                          </a>
                        </div> <br>
                      </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($empresas as $empresa)
                                    <tr>
                                        <td></td>
                                        <td>{{ $empresa->id }}</td>
                                        <td><a href="{{ asset('page-users-view') }}">{{ $empresa->nombre_empresa }}</a></td>
                                        <td>{{ $empresa->nro_nit_empresa }}</td>
                                        <td>{{ $empresa->created_at }}</td>
                                        <td>{{ $empresa->direccion }}</td>
                                        <td>+ 591 {{ $empresa->telefono }}</td>
                                        <td> <span class="green-text">{{ $empresa->representante_legal }}</span>
                                            </span> </td>
                                        ...
                                        <td><span><a onclick="eliminar('{{ $empresa->id }}')"><i
