<div id="modalCrearSubFamilia" class="modal">
        ...
        <form>
            <div class="row">
                <div class="input-field col m12 s12">
                    ...
                    <input type="text" class="autocomplete" id="nombre_sub_familia" placeholder="Nombre">
                </div>
                <div class="input-field col m12 s12">
    ...
    <div class="modal-footer">
        ...
        <button id="registrarSubFamilia" class="modal-action waves-effect blue btn ">Guardar</button>
        <button id="actualizarSubFamilia" class="modal-action waves-effect blue btn display-none">Actualizar</button>
    </div>
</div>